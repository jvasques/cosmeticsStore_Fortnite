...
<template>
  <div class="glass-panel">
    ...
    <div class="space-y-3 md:hidden">
      <p v-if="!props.transactions.length" class="px-2 py-4 text-center text-sm text-white/60">
        Sem movimentações ainda.
      </p>
      <article
      ...
      >
        ...
        <p class="mt-3 text-sm text-white">{{ resolveDescription(tx) }}</p>
        <p
